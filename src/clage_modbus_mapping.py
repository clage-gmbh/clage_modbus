...
("end", 6): ["ain", 402, "Modbus register mapping minor version (const)"],
...
("quick_start", 0): ["din", 302, "Flag if this device shall start quick (deprecated)"],
...
("quick_start", 0): ["dout", 320, "Flag if device shall start quick"],
