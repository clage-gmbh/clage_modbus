...
("total_energy_Wh", 0): ["ain", 0, "Total energy consumed 32 bit [Wh]"],
("total_volume_l", 0): ["ain", 2, "Total water consumed 32 bit [l]"],
("total_tap_count", 0): ["ain", 4, "Count of water tap usages 32 bit"],
...
("update_use_beta", 0): ["dout", 510, "Flag if updates shall use BETA firmware."],
("net_aws", 0): ["dout", 511, "AWS active (not implemented)"],
("net_matter_api", 0): ["dout", 512, "Matter active (not implemented)"],
