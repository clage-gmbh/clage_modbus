...
("timer_life_s", 0): ["ain", 106, "Device total power-on time 32 bit [s]"],
("timer_power_s", 0): ["ain", 108, "Device total heating time 32 bit [s]"],
("timer_standby_s", 0): ["ain", 110, "Time since last power-on 32 bit [s]"],
